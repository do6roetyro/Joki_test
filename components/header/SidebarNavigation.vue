        ...
        <ul class="sidebar-navigation__list">
            <li class="sidebar-navigation__item" @click="toggleSubmenu('parks')">
                <a class="sidebar-navigation__link" href="#parks">
                    Парки
                    <span class="arrow" :class="{ rotated: activeSubmenu === 'parks' }"></span>
                </a>
                <ul v-if="activeSubmenu === 'parks'" class="submenu__list">
                    <li class="submenu__item"><a class="submenu__link" href="#about-restaurants">О ресторанах</a></li>
                    <li class="submenu__item"><a class="submenu__link" href="#family">Семейные</a></li>
                    <li class="submenu__item"><a class="submenu__link" href="#family-villa">Family Villa JJ</a></li>
                    <li class="submenu__item"><a class="submenu__link" href="#meal-superheroes">JJ Meal и Обед</a></li>
                </ul>
            </li>
            <li class="sidebar-navigation__item" @click="toggleSubmenu('celebrations')">
                <a class="sidebar-navigation__link" href="#celebrations">
                    Праздники
                    <span class="arrow" :class="{ rotated: activeSubmenu === 'celebrations' }"></span>
                </a>
            ...
            <li class="sidebar-navigation__item" @click="toggleSubmenu('restaurants')">
                <a class="sidebar-navigation__link" href="#restaurants">
                    Рестораны
                    <span class="arrow" :class="{ rotated: activeSubmenu === 'restaurants' }"></span>
                </a>
